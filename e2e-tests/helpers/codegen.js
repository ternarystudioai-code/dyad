...
(async () => {
  const browser = await electron.launch({
    args: [
      "../../out/ternary-darwin-arm64/ternary.app/Contents/Resources/app.asar/.vite/build/main.js",
      "--enable-logging",
      "--user-data-dir=/tmp/ternary-e2e-tests",
    ],
    executablePath:
      "../../out/ternary-darwin-arm64/ternary.app/Contents/MacOS/ternary",
  });
